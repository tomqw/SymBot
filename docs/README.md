...
- [`16f95be`](https://github.com/tomqw/SymBot/commit/16f95be) — Bumped the Docker MongoDB image from `7` to `8`
- [`8cf7e1a`](https://github.com/tomqw/SymBot/commit/8cf7e1a) — Show deal Max Funds with 2 decimals on the active deals page instead of rounding to whole numbers
